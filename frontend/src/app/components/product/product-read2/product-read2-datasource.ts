  ...
  private getSortedData(data: Product[]): Product[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        case 'id':  
       // Handle possible undefined values by treating them as equal
        const idComparison = compare(a.id || 0, b.id || 0, isAsc);
        return idComparison !== 0 ? idComparison : compare(a.name, b.name, isAsc);
        default: return 0;
      }
    });
  }
